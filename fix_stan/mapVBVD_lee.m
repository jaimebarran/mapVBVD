function twix_obj = mapVBVD_lee(filename,varargin)

%  Reads Siemens raw .dat file from VB/VD MRI raw data.
%  requires twix_map_obj_lee.m & read_twix_hdr_lee.m
%
%
...
%                          twix_map_obj_lee.m now stores the memory position of
...
for s=1:NScans
    ...
    if arg.bReadHeader
        [twix_obj{s}.hdr, rstraj] = read_twix_hdr_lee(fid);
